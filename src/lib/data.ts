...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "weight-loss",
    name: "شارك شاي",
    bio: "شاي شارك لدعم الأيض والتنشيف ضمن برنامج غذائي منتظم — مع استشارة الفريق قبل الطلب.",
    priceIQD: 35000,
    image: "/products/shark-tea-carousel-1.jpg",
    gallery: [
      "/products/shark-tea-carousel-1.jpg",
      "/products/shark-tea-carousel-2.jpg",
    ],
    howToUseVimeoId: "76979871",
    specs: [
      { label: "الشكل", value: "شاي" },
      { label: "التوقيت", value: "صباحاً أو بين الوجبات" },
      { label: "الهدف", value: "دعم التنشيف" },
    ],
  },
  {
    id: "wl-x",
